  ...
  <div class="lg:ml-64 min-h-screen flex flex-col">
    ...
    <main class="flex-1 p-4 lg:p-8">
      ...
      <div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6 mb-8">
        <!-- Stats Cards -->
        <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-200 dark:border-gray-700 hover-lift">
          ...
          <div class="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-2">24</div>
          <div class="text-sm text-green-600 dark:text-green-400">+12% from last month</div>
        </div>

        <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-200 dark:border-gray-700 hover-lift">
          <div class="flex items-center justify-between mb-4">
            <h3 class="text-sm font-medium text-gray-600 dark:text-gray-400">Active Tasks</h3>
            <i class="fas fa-tasks text-2xl text-purple-500"></i>
          </div>
          <div class="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-2">142</div>
          <div class="text-sm text-red-600 dark:text-red-400">-3% from last week</div>
        </div>

        <div class="bg-white dark:bg-gray-800 rounded-2xl p-6 shadow-sm border border-gray-200 dark:border-gray-700 hover-lift md:col-span-2 lg:col-span-1">
          <div class="flex items-center justify-between mb-4">
          ...
          <div class="text-3xl font-bold text-gray-900 dark:text-gray-100 mb-2">8</div>
          <div class="text-sm text-blue-600 dark:text-blue-400">2 new this month</div>
        </div>
      </div>
        ...
        <div class="p-6">
          <div class="space-y-4">
            <div class="flex items-center gap-4">
              ...
              <div class="flex-1">
                <p class="text-sm text-gray-900 dark:text-gray-100">New project "Website Redesign" created</p>
            ...
            <div class="flex items-center gap-4">
              ...
              <div class="flex-1">
                <p class="text-sm text-gray-900 dark:text-gray-100">Task "Update database schema" completed</p>
            ...
            <div class="flex items-center gap-4">
              ...
              <div class="flex-1">
                <p class="text-sm text-gray-900 dark:text-gray-100">Sarah joined the development team</p>
